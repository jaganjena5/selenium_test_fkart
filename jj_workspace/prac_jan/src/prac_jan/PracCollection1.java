...
public class PracCollection1 {
	...
	public static void main(String[] args) {
		...
		abs2.addAll(abs1);
		System.out.println("does all elements present : "+abs2.containsAll(abs1));
		System.out.println("abs2: "+abs2);
		System.out.println("abs2 size: "+abs2.size());
		abs2.remove("to");
		System.out.println("abs2: "+abs2.toString());
		abs2.clear();
		System.out.println(abs2);
		System.out.println(abs2.isEmpty());
		System.out.println(abs.contains("Pal...."));
		System.out.println(abs.contains("mu."));
		System.out.println(abs.contains("mu.. "));
	}
}
